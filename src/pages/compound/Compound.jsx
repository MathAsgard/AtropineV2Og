...
import farms from "../../config/constants/autocompounds.js"
	...
	return (
		<Layout>
			<div className="atropine-top text-base">
				...
				<div>
					Stake your LP Tokens and AutoCompound in your sleep!
				</div>
				<div
					className="mx-auto"
				...
				>
					...
					<div className="col-6 col-md-3">
							<DropdownGroup options={options} dropDownFilter={dropDownFilter}/>
						</div>
						<div className="col-6 col-md-3">
						<input
								type="text"
			...
			>
				{farmsArray.map((farm, index) => (
						<CompoundCard key={index} objectToFilter={objectToFilter} active={active} search={search} stakedOnly={stacked} dropdown={dropdown} {...farm} />
				))}
			</div>
		</Layout>
	);
