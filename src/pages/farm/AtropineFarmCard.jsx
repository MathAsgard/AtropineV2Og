...
const AtropineFarmCard = ({
  ...
  async function getStats() {
    const query =
      "0x0E4B3d3141608Ebc730EE225666Fd97c833d553E" + "," + farm.lpAddress;
    ...
    if (pairData?.liquidity) {
      _lpPrice =
        Number(pairData.liquidity.usd) / (Number(lpSupply.result) / 1e18);
    } else {
      _lpPrice =
        ((Number(pairPineBalance.result) / 1e18) * pinePrice * 2) /
        (Number(lpSupply.result) / 1e18);
    }
    ...
    const _totalLiquidity = Number(
      _lpPrice * (Number(masterchefLpBalance.result) / 1e18)
        ...
        <div className="innerdiv">
          ...
          <div className="atropine-middle poppins">
            <div className="pt-3">
              ...
              <div className="txt5">
                {Number(stakedLpBalance).toLocaleString(undefined, {
                  minimumFractionDigits: 3,
                  maximumFractionDigits: 3,
                })}
              </div>
              ...
              <div className="details-txt">
                <div className="mb-1">
                  ...
                  <Link
                    to={lpLink}
                    target="_blank"
                    className="text-base hover-text-base"
                  >
        ...
        <div className="modal-inner">
          ...
          <ModalBody>
            <table className="table __table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    {(
                      (pineEarnedPerThousand1D /
                        oneThousandDollarsWorthOfPine) *
                      100
                    ).toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                  ...
                  <td>
                    {pineEarnedPerThousand1D.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    {pineEarnedPerThousand7D.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    {pineEarnedPerThousand30D.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    {pineEarnedPerThousand365D.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
            ...
            <div className="roi-text">
              ...
              are estimates provided for your convenience only, and by no means
            ...
            <div className="text-center">
              <Link
                ...
                to={lpLink}
                target="_blank"
                style={{ height: "24px", lineHeight: "24px", color: "#280046" }}
              >
            ...
            {shakeModalShow === "stake" && (
              <div>
                <div className="text-end fs-14 mb-11">
                  {Number(lpBalance).toLocaleString(undefined, {
                    minimumFractionDigits: 4,
                    maximumFractionDigits: 4,
                  })}{" "}
                  {farm.lpSymbol} Available
                </div>
                ...
                <div className="stake-form-group">
                  ...
                  />
                  <button
                    className="max no-gutter text-white"
                    onClick={setMaxStakeInput}
                  >
                    Max
                  </button>
                </div>
